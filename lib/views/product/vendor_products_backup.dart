...
class VendorProducts extends StatefulWidget {
  int vendorId;
  String vendorName;
  VendorProducts({Key? key, required this.vendorId, required this.vendorName})
      : super(key: key);
...
class _VendorProductsState extends State<VendorProducts> {
  ...
  String? Qty;
  onCallBack(
      int myVariantId, String Qty, String productPrice, String id) async {
  ...
  // vendors api
  // add to cart api
  Future<void> addtocartapi(BuildContext context, String productId,
      String variantId, String qty) async {
    serviceslist!.clear();
    productlist!.clear();
    Loader.showAlertDialog(context, true);
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  // add to cart api
  // add to cart api
  Future<void> addtocartapi2(BuildContext context, String productId,
      String variantId, String qty) async {
    Loader.showAlertDialog(context, true);
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? auth_token = prefs.getString('auth_token');
