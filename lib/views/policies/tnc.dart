...
class _TNCState extends State<TNC> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            tncdata == null || tncdata == '' ? Container() : Html(
              data: tncdata,
            ),
          ],
        ),
  ...
  Future<void> tncapi(BuildContext context) async {
    ...
    var response = await http.post(Uri.parse(Urls.tncUrl),
    ...
    TNCModel res = await TNCModel.fromJson(jsonResponse);
    if (res.status == true) {
      tncdata = res.data!.tnc;
      setState(() {});
    } else {
